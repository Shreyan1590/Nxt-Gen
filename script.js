...
const Footer = ({
    ...
    return (
        ...
        <a href="https://www.instagram.com/nxtgencomputing.sse/"
        target="_blank"
        rel="noopener noreferrer"
        className="social-icon social-instagram"
        aria-label="Instagram">
        <span className="social-icon-layer"></span>
        <span className="social-icon-layer"></span>
        <span className="social-icon-layer"></span>
        <span className="social-icon-layer"></span>
        ...
        <h4>Quick Links</h4>
        <a href="#about"
        onClick={(e) => handleClick(e, '#about')}>About</a>
        <a href="#research"
        onClick={(e) => handleClick(e, '#research')}>Research</a>
        <a href="#faculty"
        onClick={(e) => handleClick(e, '#faculty')}>Faculty</a>
        </div>
        <div className="footer-links-col">
        <h4>Resources</h4>
        <a href="#gallery"
        onClick={(e) => handleClick(e, '#gallery')}>Gallery</a>
        <a href="#events"
        onClick={(e) => handleClick(e, '#events')}>Events</a>
        <a href="#contact"
        onClick={(e) => handleClick(e, '#contact')}>Contact</a>
        </div>
        <div className="footer-links-col">
        <h4>Connect</h4>
